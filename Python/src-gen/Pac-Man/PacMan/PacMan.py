...
from LinguaFrancaPacMan import (  # pylint: disable=no-name-in-module, import-error
...
# Instantiate classes
pacman_lf = [None] * 1
pacman_controller_lf = [None] * 1
pacman_player_lf = [None] * 1
pacman_pinky_lf = [None] * 1
pacman_blinky_lf = [None] * 1
pacman_inky_lf = [None] * 1
pacman_clyde_lf = [None] * 1
pacman_display_lf = [None] * 1
# Start initializing PacMan of class PacMan
for pacman_i in range(1):
    bank_index = pacman_i
    pacman_lf[0] = _PacMan(
        _bank_index = 0,
    )
    # Start initializing PacMan.controller of class GameController
    for pacman_controller_i in range(1):
        bank_index = pacman_controller_i
        pacman_controller_lf[0] = _GameController(
            _bank_index = 0,
            _number_of_ghosts=4,
        )
    # Start initializing PacMan.player of class Player
    for pacman_player_i in range(1):
        bank_index = pacman_player_i
        pacman_player_lf[0] = _Player(
            _bank_index = 0,
            _width=pacman.w,
            _height=pacman.p_h,
    ...
    for pacman_pinky_i in range(1):
        bank_index = pacman_pinky_i
        pacman_pinky_lf[0] = _Ghost(
            _bank_index = 0,
            _width=pacman.w,
            _height=pacman.m_h,
    ...
    for pacman_blinky_i in range(1):
        bank_index = pacman_blinky_i
        pacman_blinky_lf[0] = _Ghost(
            _bank_index = 0,
            _width=pacman.w,
            _height=pacman.b_h,
    ...
    for pacman_inky_i in range(1):
        bank_index = pacman_inky_i
        pacman_inky_lf[0] = _Ghost(
            _bank_index = 0,
            _width=pacman.i_w,
            _height=pacman.m_h,
    ...
    for pacman_clyde_i in range(1):
        bank_index = pacman_clyde_i
        pacman_clyde_lf[0] = _Ghost(
            _bank_index = 0,
            _width=pacman.c_w,
            _height=pacman.m_h,
    ...
    for pacman_display_i in range(1):
        bank_index = pacman_display_i
        pacman_display_lf[0] = _Display(
            _bank_index = 0,
