...
set output 'LagLANConsistency.pdf'
...
plot for [i=1:6] 'LAN_Consistency_results.csv' using (2*i):i lt 1 title (i==1 ? 'Zero Delay Cycle' : ''),\
for [i=1:6] 'LAN_ConsistencyMicrostepDelay_results.csv' using (2*i + 1):i lt 2 title (i==1 ? 'Microstep Delay Cycle' : '')